...
var ReactMde = /** @class */ (function (_super) {
    ...
    ReactMde.prototype.render = function () {
        var _this = this;
        var _a, _b, _c, _d, _e;
        var _f = this.props, getIcon = _f.getIcon, commands = _f.commands, classes = _f.classes, className = _f.className, loadingPreview = _f.loadingPreview, emptyPreviewHtml = _f.emptyPreviewHtml, readOnly = _f.readOnly, disablePreview = _f.disablePreview, value = _f.value, l18n = _f.l18n, minPreviewHeight = _f.minPreviewHeight, textAreaProps = _f.textAreaProps, selectedTab = _f.selectedTab, generateMarkdownPreview = _f.generateMarkdownPreview;
        return (React.createElement("div", { className: ClassNames_1.classNames("react-mde", "react-mde-tabbed-layout", (_a = classes) === null || _a === void 0 ? void 0 : _a.reactMde, 
             ...
             */
            className) },
            React.createElement(_1.MdeToolbar, { classes: (_b = classes) === null || _b === void 0 ? void 0 : _b.toolbar, getIcon: getIcon, commands: commands, onCommand: this.handleCommand, onTabChange: this.handleTabChange, tab: selectedTab, readOnly: readOnly, disablePreview: disablePreview, l18n: l18n }),
            selectedTab === "write" ? (React.createElement(React.Fragment, null,
                React.createElement(_1.TextArea, { classes: (_c = classes) === null || _c === void 0 ? void 0 : _c.textArea, editorRef: this.setTextAreaRef, onChange: this.handleTextChange, readOnly: readOnly, textAreaProps: textAreaProps, height: this.state.editorHeight, value: value }),
                React.createElement("div", { className: ClassNames_1.classNames("grip", (_d = classes) === null || _d === void 0 ? void 0 : _d.grip), onMouseDown: this.handleGripMouseDown },
                    React.createElement("svg", { "aria-hidden": "true", "data-prefix": "far", "data-icon": "ellipsis-h", role: "img", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 512 512", className: "icon" },
                        React.createElement("path", { fill: "currentColor", d: "M304 256c0 26.5-21.5 48-48 48s-48-21.5-48-48 21.5-48 48-48 48 21.5 48 48zm120-48c-26.5 0-48 21.5-48 48s21.5 48 48 48 48-21.5 48-48-21.5-48-48-48zm-336 0c-26.5 0-48 21.5-48 48s21.5 48 48 48 48-21.5 48-48-21.5-48-48-48z", className: "" }))))) : (React.createElement(_1.MdePreview, { classes: (_e = classes) === null || _e === void 0 ? void 0 : _e.preview, previewRef: function (c) { return (_this.previewRef = c); }, loadingPreview: loadingPreview || emptyPreviewHtml, minHeight: minPreviewHeight, generateMarkdownPreview: generateMarkdownPreview, markdown: value }))));
    };
